...
model = torch.load('/home/voronov/projects/style-transfer-paraphrase/style_paraphrase/evaluation/similarity/sim.pt')
...
sp.Load('/home/voronov/projects/style-transfer-paraphrase/style_paraphrase/evaluation/similarity/sim.sp.30k.model')
model.eval()
